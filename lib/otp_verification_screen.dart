...
import 'package:neximoapi_phoneauth/custom_textfield.dart';
import 'package:neximoapi_phoneauth/progress_hud.dart';
...
class _OtpVerificationScreenState extends State<OtpVerificationScreenState> {
  ...
  void initState() {
    ...
    _nexmoSmsVerificationUtil.initNexmo("1350ee28", "EMCOYecgi6590boR");
  }

  bool isVerified = false;

  void _submit() {
    Navigator.of(context).pushReplacementNamed('/verifiedpage');
